  ...
  return (
    ...
    <div className="container mx-auto flex px-5 py-20 md:flex-row flex-col items-center">
      <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
        ...
        <p className="mb-8 leading-relaxed">Revolutionize the way you showcase your professional journey with TechyPapa Resume Builder – this ultimate tool helps you craft a winning resume! Effortlessly. Say goodbye to the traditional ways because <b>TechyPapa</b> is here to help you get your <b>dream job</b>.</p>
