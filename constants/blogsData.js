...
export const blogsData = [
    ...
    },
    {
        category: 'HEALTH',
        date: `${dateNow.getDate()} / ${dateNow.getMonth()+1} / ${dateNow.getFullYear()}`,
        blogName: 'Mindful Living: A Holistic Approach to Well-being',
        blogDesc: 'Explore the principles of mindful living and cultivate a holistic approach to well-being. Learn practical tips, mindfulness exercises, and embrace a balanced lifestyle for a healthier you.'
    },
    {
        category: 'ART',
        date: `${dateNow.getDate()} / ${dateNow.getMonth()+1} / ${dateNow.getFullYear()}`,
        blogName: 'Expressive Photography: Capturing Emotions Through the Lens',
        blogDesc: 'Immerse yourself in the world of expressive photography. Discover techniques to capture emotions, tell compelling stories through your lens, and elevate your photography to new heights.'
    },
    {
        category: 'FOOD',
        date: `${dateNow.getDate()} / ${dateNow.getMonth()+1} / ${dateNow.getFullYear()}`,
        blogName: 'Culinary Adventures: Exploring Global Flavors',
        blogDesc: 'Embark on a culinary journey around the world. Delight your taste buds with diverse flavors, traditional recipes, and the rich cultural tapestry that defines global cuisine.'
    }
];